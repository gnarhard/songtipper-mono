<section>
    <header>
        <h2 class="text-lg font-medium text-ink dark:text-ink-inverse">
        ...
        <div class="flex items-center gap-4">
            ...
            @if (session('status') === 'profile-updated')
                <p
                    ...
                    class="text-sm text-ink-muted dark:text-ink-soft"
                >{{ __('Saved.') }}</p>
            @endif
        </div>
    </form>
